package com.curry.stephen.lar.jme;
...
public class CameraAccessApplication extends SimpleApplication {
    ...
    public static void main(String[] args) {
        CameraAccessApplication app = new CameraAccessApplication();
        app.start();
    }
    ...
    public static String getFullName() {
        return CameraAccessApplication.class.getName();
    }
}
